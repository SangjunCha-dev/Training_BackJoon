...
def main():
    ...
    if clock_hour < 0 or 23 < clock_hour:
        return
    elif clock_min < 0 or 59 < clock_min:
        return

    clock_hour_pre = 0
    clock_min_pre = 0
    if 0 <= (clock_min - 45):
        clock_hour_pre = clock_hour
        clock_min_pre = clock_min - 45
    else:
        clock_hour_pre = clock_hour - 1
        clock_min_pre = clock_min - 45 + 60
        if clock_hour_pre < 0:
            clock_hour_pre = clock_hour_pre + 24

    print(clock_hour_pre, clock_min_pre)
